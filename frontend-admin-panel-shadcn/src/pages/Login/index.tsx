...
export default function LoginPage() {
  ...
  const [loginMode, setLoginMode] = useState<'normal' | 'apple' | 'google' | 'meta'>('normal');
    ...
    <div className="bg-muted flex min-h-svh flex-col items-center justify-center p-6 md:p-10">
      <div className="flex w-full max-w-sm flex-col gap-6 md:max-w-4xl">
          ...
          <CardContent className="grid p-0 md:grid-cols-2">
            <Form {...form}>
              <form className="p-6 md:p-8" onSubmit={form.handleSubmit(handleSubmit)}>
                <FieldGroup className="min-h-[420px] justify-center">
                      ...
                      >
                        ...
                        <Field className="grid grid-cols-3 gap-4">
                          ...
                          >
                            ...
                            <span className="sr-only">用户名方式登录</span>
                          </Button>
                        </Field>
                      </motion.div>
                    ) : loginMode === 'google' ? (
        ...
        <FieldDescription className="px-6 text-center">
          点击登录即表示您同意我们的{' '}
          <a href="#" className="hover:text-primary">服务条款</a> 和{' '}
